...
const keepLooping = async () => {
  await new Promise((resolve, _reject) => {
    ...
    const setTimeoutHandler = () => {
      ...
      // -- AD THAT STAY ON TOP OF THE RECOMMEND VIDEO
      ...
      document.hideElementsBySelector(".player-ads");
      document.hideElementsBySelector(".ytd-in-feed-ad-layout-renderer");
      document.hideElementsBySelector(".ytd-engagement-panel-section-list-renderer");
      // -- AD FOR YOUTUBE FEATURED
      document.hideElementsBySelector(".ytd-brand-video-singleton-renderer");
      document.hideElementsBySelector(".ytd-primetime-promo-details-renderer");
      resolve();
    };
